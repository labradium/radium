...
export default function Home() {
	return (
		<main className={"relative flex h-screen flex-col items-center justify-center"}>
			<Label className={"text-4xl font-semibold"}>Radium Next.js Blog Template</Label>
			<p className={"mx-8 my-4 max-w-3xl text-center text-base"}>
				This is a blog template built with Next.js and Radium. It features a responsive design, customizable layout, and
			...
			<Link href={"https://github.com/vgseven/radium"} className={"mb-6"} target={"_blank"}>
